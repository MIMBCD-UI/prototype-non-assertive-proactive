# Non-Assertive and Proactive Prototype
...
```
git clone git@github.com:MIMBCD-UI/prototype-non-assertive-proactive.git
```

2.1.2. Go inside the project folder:

```
cd prototype-non-assertive-proactive/
```
